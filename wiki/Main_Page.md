...
-   [The Solectria Sunrise](http://www.austinev.org/evalbum/655.html)
    ...
    there yet! It is being reborn as the [Sunrise
    EV2](http://www.sunrise-ev.com/) by a group headed by Lee Hart
    &lt;sunrise.ev@earthlink.net&gt;. The EV2 will be sold as a kit car,
    to enable anyone to have a high performance electric vehicle without
    the limitations of a conversion.
-   [Zap
